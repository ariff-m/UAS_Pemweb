...
<head>
  ...
  <title>UKM UPNVJT - Data UKM</title>
  <!-- Data Tables -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div>
                ...
                <a type="button" class="btn btn-danger" href="functions.php?id=<?= $row['id'] ?> &proses=ukmREMOVE"
                  onclick="return confirm('Apakah kamu yakin menghapus data UKM : <?= $row['ukm']; ?> ?');">REMOVE</a>
              </div>
            </div>
          </div>
